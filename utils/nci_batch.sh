...
# the python script needs full path of the python script
mpirun -np 3 python utils/batch_job.py -i ../../covariates/national/ -o ../../covariates/national_LCC/ -m ../../covariates/masks/model_mask.tif -r bilinear -e '-2362974.47956 -5097641.80634 2251415.52044 -1174811.80634'